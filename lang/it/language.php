...
"The following list of changes has been applied" => "É stata apportata la seguente lista di cambiamenti",
"Profile forgotten" => "Profilo non trovato",
...
"Zambia" => "Zambia",
"Zimbabwe" => "Zimbabwe",
"Are you sure you want to remove that post" => "Sei sicuro di voler rimuovere questo post",
"Re:" => "Re:",
...
"Files" => "File",
"Hits" => "Hits",
"Last download" => "Ultimo download",
"Locked by" => "Bloccato da",
"Backlinks" => "Backlinks",
"Source" => "Fonte",
"Path" => "Percorso",
"Gallery icon" => "Galleria icone",
"Register" => "Registra",
"Group" => "Gruppo",
"Invalid database user" => "Database user non valido",
"No database name specified" => "Nome database non specificato",
"Automatic" => "Automatico",
"Make a copy" => "Crea una copia",
"Email address not valid, test mail not sent" => "Indirizzo email non valido, test mail non inviata",
"Tiki version" => "Versione Tiki",
"PHP version" => "Versione PHP",
"Server" => "Server",
"Sent" => "Inviato",
"is not a number" => "non è un numero",
"must be greater than 0" => "deve essere maggiore di 0",
"does not exist" => "non esiste",
"already exists" => "esiste già",
"Edited article post" => "Articolo modificato",
"Deleted article post" => "Articolo eliminato",
"The file has incorrect syntax or is not a CSV file" => "Il file ha una sintassi errata o non è un file CSV",
"Error line: %d" => "Errore linea: %d",
"anonymous" => "anonimo",
"refresh" => "aggiorna",
...
"in" => "in",
"continued" => "continuo",
"New Image Uploaded by" => "Nuova immagine caricata da",
"New Subscriptions" => "Nuova sottoscrizione",
...
"Empty CAPTCHA value" => "Valore CAPTCHA vuoto",
"Failed to validate CAPTCHA" => "Validazione CAPTCHA fallita",
"Help" => "Aiuto",
"Play sound again" => "Riproduci suono di nuovo",
"Incorrect. Try again" => "Sbagliato. Prova ancora",
"Top" => "Top",
"article" => "articolo",
"blog" => "blog",
"directory" => "directory",
...
"Invalid filename (using filters for filenames)" => "Nome file errato (in base ai filtri di ricerca per nomi file)",
"Cannot upload this file - maximum upload size exceeded" => "Impossibile caricare il file - dimensione upload massima superata",
"Cannot write to this file" => "Impossibile scrivere su questo file",
"(not registered)" => "(non registrato)",
"Anonymous" => "Anonimo",
"Wrong password. Cannot post comment" => "Password errata. Impossibile pubblicare il commento",
"This forum is locked" => "Questo forum è bloccato",
"This thread is locked" => "Questo thread è bloccato",
"An error occurred; please contact the administrator" => "Si è verificato un errore; per favore contatta l'amministratore",
...
"Success" => "Successo",
"Warning" => "Warning",
"Articles deleted" => "Articoli eliminati",
"removed the article" => "ha rimosso l'articolo",
"Edited articles" => "Articoli modificati",
"edited the article" => "ha modificato l'articolo",
"created the article" => "ha creato l'articolo",
"New calendar events" => "Nuovo evento del calendario",
"created the subcategory" => "ha creato la sottocategoria",
"removed the subcategory" => "ha rimosso la sottocategoria",
"from" => "da",
"edited the category" => "ha modificato la sottocategoria",
"%0 uploaded the file %1" => "%0 ha caricato il file %1",
"onto" => "su",
"%0 removed the file %1 from %2" => "%0 ha rimosso il file %1 da %2",
"URL" => "URL",
"Tentative" => "Tentativo",
...
"unknown" => "sconosciuto",
"Unknown" => "Sconosciuto",
"Tracker Status" => "Stato Tracker",
"Open" => "Aperto",
"First word" => "Prima parola",
"Please confirm" => "Per favore conferma",
"OK" => "Ok",
"No activities deleted" => "Nessuna attività rimossa",
"Delete Activity" => "Rimuovi Attività",
"Sample" => "Esempio",
"Basic" => "Semplice",
"Oops" => "Oops",
"Comments not allowed on this page" => "Commenti non consentiti in questa pagina",
"Loading.." => "Caricamento..",
"Feature disabled" => "Funzione disabilitata",
"Preview" => "Anteprima",
"Edit" => "Modifica",
...
"Unknown errors" => "Errore sconosciuto",
"File empty" => "File vuoto",
"You don't have permission to upload zipped file packages" => "Non hai il permesso di caricare pacchetti di file zippati",
"Browse" => "Visita",
"Merge" => "Unisci",
"Move" => "Sposta",
"Delete" => "Elimina",
...
"You do not have the permission that is needed to use this feature" => "Permesso negato, non hai accesso a questa sezione",
"username" => "username",
"password" => "password",
"second" => "secondo",
"done" => "fatto",
...
"Send the posts of this forum to this email address" => "Invia messaggi di questo forum a questa email",
"Prune unreplied-to messages after" => "Elimina messaggi senza repliche dopo",
...
"Default order of topics" => "Ordinamento di default per gli argomenti",
...
"Admin Newsletters" => "Admin newsletter",
"The newsletter was sent to %0 email addresses" => "The newsletter was sent to {\$sent} email addresses",
