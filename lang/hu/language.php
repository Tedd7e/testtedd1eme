...
"Parse search results" => "Eredmények elemzése",
...
"You do not have the permission that is needed to use this feature" => "Magasabb csoportszintű jogosultágra van szükséged, hogy ezt a funkciót használhasd",
...
"Send emails even when the post is generated by an inbound email" => "Levelek küldése ha a hozzászólást beérkező levél generálta",
"Append a reply link to outbound mails" => "Válaszlink hozzáadása a kimenő levelekhez",
"Originating email address for emails from this forum" => "Ezen fórum leveleihez tartozó forrás Email cím",
