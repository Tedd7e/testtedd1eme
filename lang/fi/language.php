...
"Comparing version %0 with version %1" => "Verrataan versiota {\$old.version} versioon {\$new.version}",
"Version:" => "Versio:",
"Current" => "Nykyinen",
...
"Send the posts of this forum to this email address" => "Lähetä tämän foorumin lähetykset tähän sähköpostiosoitteeseen",
"Prune unreplied-to messages after" => "Poista vastaamattomat viestit kun täyttyy",
...
"Send emails even when the post is generated by an inbound email" => "Lähetä viestit vaikka posti olisi luotu saapuneista",
"Append a reply link to outbound mails" => "Lisää vastaus linkki lähteviin posteihin",
"Originating email address for emails from this forum" => "Alkuperäinen sähköpostiosoite lähetyksille tältä foorumilta",
...
"Default order of topics" => "Aiheiden oletus järjestys",
...
"The newsletter was sent to %0 email addresses" => "Uutislehti on lähetetty {\$sent} sähköposti osoitteisiin",
