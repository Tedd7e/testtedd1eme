...
"You do not have the permission that is needed to use this feature" => "權限不足, 無法使用本功能",
"username" => "使用者名稱",
"password" => "密碼",
"second" => "秒",
"done" => "完成",
...
"Send the posts of this forum to this email address" => "寄送此論壇文章到這個電子郵件",
"Prune unreplied-to messages after" => "刪去未回覆的訊息於",
"Prune old messages after" => "刪去舊訊息於",
"Add messages from this email to the forum" => "將來自此 email 的訊息增加至論壇",
"POP3 server" => "POP3 伺服器",
"Default order of topics" => "預設主題排列順序",
...
"Sent editions" => "送出版本",
"Admin Newsletters" => "管理電子報",
"The newsletter was sent to %0 email addresses" => "電子報已發送至 {\$sent} email 地址",
