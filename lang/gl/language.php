...
"You do not have the permission that is needed to use this feature" => "Non ten permiso para acceder a esta característica",
...
"Comparing version %0 with version %1" => "Comparar a versión {\$old.version} coa versión {\$new.version}",
"Version:" => "Versión:",
"Current" => "Actual",
...
"Send the posts of this forum to this email address" => "Enviar artigos deste foro a este correo-e",
"Prune unreplied-to messages after" => "Eliminar mensaxes sen respostas despois de",
...
"Send emails even when the post is generated by an inbound email" => "Enviar correos mesmo cando o envío é xerado por unha mensaxe entrante",
"Append a reply link to outbound mails" => "Agregar unha ligazón de resposta ás mensaxes saíntes",
"Originating email address for emails from this forum" => "Enderezo orixe de correo-e para correos deste foro",
...
"Default order of topics" => "Orde por defecto para temas",
...
"Admin Newsletters" => "Administrar boletíns",
"The newsletter was sent to %0 email addresses" => "O boletín foi enviado a {\$sent} enderezos de correo",
