...
"You do not have the permission that is needed to use this feature" => "Немає дозволу на користування цією функцією",
"username" => "ім'я користувача",
"password" => "пароль",
"second" => "секунда",
"done" => "готово",
...
"Send the posts of this forum to this email address" => "Надсилати публікації цього форуму на дану адресу",
"Prune unreplied-to messages after" => "Стирати повідомлення, на які не було відповіді після",
...
"Originating email address for emails from this forum" => "Вихідна електронна адреса для листів з цього форуму",
...
"Default order of topics" => "Стандартне сортування тем",
...
"The newsletter was sent to %0 email addresses" => "Листок новин надіслано за {\$sent} поштовими адресами",
