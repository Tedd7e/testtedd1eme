...
"You do not have the permission that is needed to use this feature" => " دسترسي ممنوع است:متاسفانه شما نمي‌توانيد از اين خصيصه استفاده كنيد",
"username" => "نام كاربري",
"password" => "كلمه‌ي عبور‌",
...
"Comparing version %0 with version %1" => "مقايسه‌ي نسخه‌ي {\$old.version} با نسخه‌ي {\$new.version}",
"Version:" => "نسخه:",
"Current" => "جاري",
...
"Send the posts of this forum to this email address" => "الصاق‌هاي اين انجمن را به اين پست الكترونيكي بفرست",
"Prune unreplied-to messages after" => "پيغام‌هاي بدون جواب بايد بعد از چند روز هرس(حذف) شوند؟",
...
"Send emails even when the post is generated by an inbound email" => "حتي هنگامي كه خود الصاق به وسيله‌ي پست الكترونيكي ايجاد شده است، پست الكترونيكي را ارسال كن!؟",
"Append a reply link to outbound mails" => "يك پيوند 'پاسخ' به پست‌هاي الكترونيكي خروجي اضافه كن؟",
"Originating email address for emails from this forum" => "پست‌هاي الكترونيكي ارسالي از اين انجمن، از طرف اين آدرس ارسال مي‌شوند:",
...
"Default order of topics" => "ترتيب پيش‌فرض براي موضوعات",
...
"Admin Newsletters" => "مديريت خبرنامه‌ها",
"The newsletter was sent to %0 email addresses" => "خبرنامه براي پست‌هاي الكترونيكي {\$sent} ارسال شد.",
