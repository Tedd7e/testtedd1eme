...
"You do not have the permission that is needed to use this feature" => "Rättigheter att använda denna funktion saknas",
"username" => "användarnamn",
"password" => "lösenord",
"second" => "sekund",
"done" => "klar",
...
"Prune unreplied-to messages after" => "Radera obesvarade meddelanden efter",
...
"Send emails even when the post is generated by an inbound email" => "Skicka e-post även när inlägget skapats av inkommande e-post",
"Append a reply link to outbound mails" => "Lägg till en svarslänk till utgående e-post",
"Originating email address for emails from this forum" => "Avsändarens e-postadress från detta forum",
...
"Default order of topics" => "Förvald sortering av ämnen",
...
"Admin Newsletters" => "Admin. nyhetsbrev",
"The newsletter was sent to %0 email addresses" => "Nyhetsbrevet skickades till {\$sent} e-mejladresser",
