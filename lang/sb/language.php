...
"You do not have the permission that is needed to use this feature" => "Tambu fo iusim disfala samting/feature",
"username" => "usernem",
"password" => "paswod",
"second" => "second",
"done" => "finis",
...
"Send the posts of this forum to this email address" => "Sendem olketa post blong disfala forum go long disfala email",
"Prune unreplied-to messages after" => "Prune olketa mesij wea i no bin replied afta",
...
"Originating email address for emails from this forum" => "Olketa email adres blong olketa email from disfala forum",
...
"Default order of topics" => "Default oda fo olketa topik",
...
"Admin Newsletters" => "Olketa niusleta blong admin",
"The newsletter was sent to %0 email addresses" => "Niusleta hemi bin sendem go long {\$sent} olketa email adres ia",
