...
"Global site configuration, date formats, etc." => "Configuração global do site, formato de data, etc.",
"Features" => "Recursos",
"Look & Feel" => "Aparência",
"Modules" => "Módulos",
...
"User related preferences like info and picture, features, messages and notification, files, etc" => "Preferências relacionadas ao Usuário, como informações e foto, funcionalidades, mensagens e notificações, arquivos, etc.",
"Rating" => "Nota",
"Score" => "Pontuação",
"Tags" => "Tags",
"Polls" => "Enquetes",
...
"You do not have the permission that is needed to use this feature" => "Permissão negada para usar este recurso.",
...
"User Info and Picture" => "Informações do Usuário e Foto",
"User information display" => "Exibição de informações dos usuários",
"Messaging and Notifications" => "Mensagens e Notificações",
...
"Comparing version %0 with version %1" => "Comparando versão {\$old.version} com a versão {\$new.version}",
"Version:" => "Versão:",
"Current" => "Atual",
...
"Send the posts of this forum to this email address" => "Enviar as mensagens deste fórum para o seguinte e-mail",
"Prune unreplied-to messages after" => "Mensagens não respondidas expiram após",
...
"Send emails even when the post is generated by an inbound email" => "Enviar e-mails mesmo quando a mensagem for gerada por lixo eletrônico",
"Originating email address for emails from this forum" => "Originar endereços de e-mail para mensagens deste fórum",
...
"Default order of topics" => "Ordenação padrão para os assuntos",
...
"Admin Newsletters" => "Administrar comunicados",
"The newsletter was sent to %0 email addresses" => "O comunicado foi enviado para {\$sent} endereços de email",
...
"Files are read only at this time" => "Arquivos são somente para leitura no momento",
